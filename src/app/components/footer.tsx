    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12 bg-gray-900">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Muzzu Rentals</h3>
            <p className="text-gray-300 mb-4">
              Professional camera rentals for photographers and videographers. Quality equipment for your creative
              projects.
            </p>
